 ...
 */
public class CSuppliers extends ConfigDB {
    ...
    public void clearRowTableIfAlreadyExists() {
    ...
    public void viewData() {
        try {
            ...
            String[] col = {"ID Supplier", "Nama Perusahaan", "Alamat", "Kota", "Kabupaten", "Kode POS", "No. Telp", "Kontak", "E-Mail", "Faximile"};
    ...
    public void searchViewData(String teksCari) {
        try {
            clearRowTableIfAlreadyExists();
            String sql = "SELECT * FROM `Suppliers` Where CompanyName Like '%" + teksCari + "%' Or City Like '%" + teksCari + "%' Or PostalCode Like '%" + teksCari + "%'";
            String[] col = {"ID Supplier", "Nama Perusahaan", "Alamat", "Kota", "Kabupaten", "Kode POS", "No. Telp", "Kontak", "E-Mail", "Faximile"};
            model.setColumnIdentifiers(col);
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
