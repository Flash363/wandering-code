...
import com.pointofsales.swing.helper.AddProduct;
...
public class ChooseProduct extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ChooseProduct(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cp = new CProduct();
        jTable1.setModel(cp.model);
        cp.showDataProductIfStockIsLimited();
        tableRenderer();
    }
    CProduct cp;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new AddProduct(null, true).setVisible(true);
