 ...
 */
public class FSalesCash extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FSalesCash(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .add(jPanel6Layout.createSequentialGroup()
                ...
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(txtNamaBarang)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, txtStok))
                .add(18, 18, 18)
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jLabel18)
                    .add(jLabel17)
                ...
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel6Layout.createSequentialGroup()
                        .add(txtDiscPersen)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(txtHasilDiskon, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 198, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, txtHargaJual, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 258, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        if (txtIdBarang.getText().isEmpty()) {
            ...
            if (Integer.parseInt(txtStok.getText()) < Integer.parseInt(txtQty.getText())) {
                ...
                model.addRow(new Object[]{txtIdBarang.getText(), txtNamaBarang.getText(), Integer.parseInt(txtQty.getText()), satuan, Integer.parseInt(txtHargaJual.getText()),
                    txtDiscPersen.getText(), Integer.parseInt(txtHargaJual.getText()) * Integer.parseInt(txtQty.getText())});
                clearField();
            }
        }
    }
    ...
    protected int getSubtotal() {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            mTotal = mTotal + Integer.parseInt(jTable1.getValueAt(i, 6).toString());
        }
        return mTotal;
    }
    ...
    protected void printSalesInvoices() {
        try {
            ...
            String localePath = System.getProperty("user.dir") + "/src/com/resources/jrxml/reportInvoice.jrxml";
            ...
            JOptionPane.showMessageDialog(null, "<html><h1>Terjadi Error Pada:</h1></html>\n" + ex.toString(), "Kesalahan", JOptionPane.PLAIN_MESSAGE, getErrorIcon());
        }
    }
