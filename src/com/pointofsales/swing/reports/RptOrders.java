 ...
 */
public class RptOrders extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RptOrders(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        open();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Pembelian-Rangkuman", pnUmum);
        ...
        jTabbedPane1.addTab("Pembelian Per-Supplier", jPanel1);
        ...
        jTabbedPane1.addTab("Pembelian Per-Kasir", jPanel2);
        ...
        jTabbedPane1.addTab("Pembelian-Rincian", jPanel3);

        pnChart.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
    ...
    private void RptCommonOrders() {
        try {
            ...
            pnUmum.revalidate();
            Date start, end;
            start = (Date) jXDatePicker1.getDate();
            end = (Date) jXDatePicker2.getDate();
            HashMap param = new HashMap();
            param.put("stDate", start);
    ...
    private void RptOrdersPerSupplier() {
        try {
            Connection conn = new ConfigDB().getConnection();
            jPanel1.removeAll();
            jPanel1.repaint();
    ...
    private void RptOrdersPerSalesman() {
        try {
            Connection conn = new ConfigDB().getConnection();
            jPanel2.removeAll();
            jPanel2.repaint();
    ...
    private void RptOrdersDetail() {
        try {
            ...
            param.put("stDate", start);
            param.put("endDate", end);
            String localPath = System.getProperty("user.dir") + "/src/com/resources/jrxml/RptOrderDetail.jrxml";
            JasperDesign jDesign = JRXmlLoader.load(localPath);
            JasperReport jReport = JasperCompileManager.compileReport(jDesign);
    ...
    private void showAllReport() {
        ...
        //RptOrdersChart();
        RptOrdersDetail();
        //RptOrdersPerSalesman();
        //RptOrdersPerSupplier();
    }
